...
Windows 本地 Agent 工作台与独立的团队管理应用。远端使用 Linux 账号、SSH/SFTP 和文件系统，无常驻业务服务。当前版本 **0.2.0**。
...
- `TeamAgent-admin-0.2.0-x64.exe`：管理员版安装程序。
- `TeamAgent-user-0.2.0-x64.exe`：用户版安装程序。
