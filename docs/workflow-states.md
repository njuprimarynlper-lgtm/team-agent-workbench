...
下文沿用旧称“个人结论库”，当前界面名称为“本地项目成果库”，按当前账号和项目组织，本机持久缓存并随个人账号同步；它不是团队公共库。Session 和对话仍只保存在本机。不同账号应使用独立账号窗口。共享成果只有通过明确上传或管理员保存操作才会改变。
...
- “移入历史”可恢复；“删除成果”会从使用中和历史列表移除，不提供恢复按钮。二者都不会删除共享内容或已有会话引用。
