...
function App() {
  ...
  return <div className="app">
    ...
    />}
    {view === 'conclusions' && project && <ConclusionLibrary categories={activeResultCombination(resultPreferences, project.id).categories} refreshToken={state.accountSync?.syncedAt} key={project.id} project={project} sessions={mergeSessions} notice={setNotice}
