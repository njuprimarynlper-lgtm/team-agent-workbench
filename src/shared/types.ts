...
export interface ProjectConclusion { accountOwner?: string; id: string; projectId: string; title: string; titleAlias?: string; content: string; sources: ConclusionSource[]; updatedAt: string; version: number; archived?: boolean; deletedAt?: string; automatic?: boolean }
