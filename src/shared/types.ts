...
export interface ConclusionSource { publication?: { path: string; sha256: string; revision: number }; details?: string; sha256?: string; id: string; kind: 'remote' | 'session' | 'manual' | 'conclusion'; title: string; content?: string; revision?: number; path?: string; updatedAt: string }
